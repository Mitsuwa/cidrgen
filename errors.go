...
// Sentinel errors returned by [Generate] and [LoadClassifications]. Callers can
...
var (
	...
	// key in Request.Classifications.
	...
	// contained within Request.Parent.
